...
export const initialTemplates: CardTemplate[] = [
  {
    id: "tpl-network-voucher-20",
    name: "قالب كروت احترافي قياسي (A4 - 20 كارت جلوبل نت)",
    description: "تصميم احترافي مطابق لبطاقات شبكات المايكروتك مع شارة السعر الدائرية وكود المستخدم البارز وفراغ قص دقيق (4×5 = 20 كارت)",
    backgroundType: "minimal_light",
    designStyle: "voucher_badge",
    themeColor: "#dc2626",
    accentColor: "#1d4ed8",
    badgeColor: "#dc2626",
    priceCircleBg: "#ffffff",
    ...
    gridCols: 4,
    gridRows: 5,
    dimensionMode: "auto_grid",
    pageMarginMm: 4,
    cardGapMm: 1, // فراغ بسيط للقص 1 ملم
    ...
    websiteUrl: "www.j.net",
    validityText: "٤ أيام",
    codeBoxStyle: "clean-border",
    codeTextColor: "#09090b",
    codeFontSize: 16,
